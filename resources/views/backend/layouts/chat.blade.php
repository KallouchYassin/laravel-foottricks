    ...
    <div class="masthead">
        <div class="masthead-content text-white">
            <div class="container-fluid px-4 px-lg-0">
                <h1 class="fst-italic lh-1 mb-4">The chat app is in coming soon !</h1>
                <p class="mb-5">We're working hard to finish the development of this site. Enter your email below to receive updates and to be notified when we launch!</p>
