...
<div class="content-wrapper">
    ...
    <!-- /.content-header -->
    <form method="POST" action="{{ route('create-event-matches') }}">
        @csrf

        <div class="card"><p class="h-1">Create Matches</p>
            <div class="bar mb-3"></div>
            <div class="row">
                <div class="col-12"><p class="mb-2">Name oppponent</p>
                    <div class=" box mb-3"><input type="text" id="opponent" name="opponent" class="form-control" placeholder="Opponent*">
                        @error('opponent')
                        <span class="text-danger">{{$message}}</span>
                        @enderror
                    </div>
                </div>
                <div class="col-12"><p class="mb-2">Championship day</p>
                    <div class=" box mb-3"><input id="ch_day" name="ch_day" type="text" class="form-control" placeholder="Championship day*">
                        @error('ch_day')
                        <span class="text-danger">{{$message}}</span>
                        @enderror
                    </div>
                ...
                <div class="col-12"><p class="mb-2">Match side</p>
                    <div class=" box mb-3">
                        <fieldset name="match_side" id="match_side">
                            <input type="radio" name="match_side" checked value="Home"> Home</input><br>
                            <input type="radio" name="match_side" value="Neutral"> Neutral</input><br>
                            <input type="radio" name="match_side"value="Outside"> Outside</input>
